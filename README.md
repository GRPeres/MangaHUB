...
- Caches MangaDex chapters for the internal admin reader, checks reading manga daily for new releases, and gradually backfills already-read chapters while the site is idle.
