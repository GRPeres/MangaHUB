...
{
    private static readonly HashSet<string> AllowedJobTypes = ["release-sync", "mangadex-status-sync", "mangadex-cache-cleanup", "mangaupdates-sync", "mangaupdates-match", "library-scan"];
